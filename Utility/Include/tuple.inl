...
constexpr auto call_with_tuple_elements(F &&f, Tuple &&args) -> decltype(call_with_tuple_elements_impl(std::forward<F>(f), std::forward<Tuple>(args), Utility::MakeIntegerSequence<std::size_t, std::tuple_size<typename std::remove_reference<Tuple>::type>::value>()))
{
